...
''' equivalent — currently BodySlide morph sliders and the LM SkinTemplate id. One file per
...
'''
''' Only NPCs with a non-empty bodyMorphs dict OR a non-empty skinTemplateId are persisted;
''' everything else is dropped to keep the file small and avoid leaving zero-NPC sidecars on
''' disk.</summary>
