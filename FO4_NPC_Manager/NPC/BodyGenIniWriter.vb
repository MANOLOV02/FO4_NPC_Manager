...
Public Module BodyGenIniWriter
    ...
    Public Sub Emit(dataPath As String, targetPluginBaseName As String, entries As List(Of NpcEntry))
        ...
        ' ⛔ LOS DOS JUNTOS O NINGUNO. `templates.ini` DEFINE los nombres que `morphs.ini` REFERENCIA: escribir
        ' el primero y fallar el segundo deja el par DESAJUSTADO —morphs viejo nombrando plantillas que el
        ' templates nuevo ya no declara, porque la migración de claves les cambia el nombre— y esos NPC pierden
        ' los body morphs EN EL JUEGO, en silencio, cuando antes andaban. Ver `EscrituraDelParBodyGen`.
    ...
    ''' <summary>Los bytes del .ini: UTF-8 SIN BOM — el parser de f4ee no lo espera.</summary>
