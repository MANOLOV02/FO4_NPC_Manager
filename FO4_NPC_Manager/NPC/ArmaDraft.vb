...
''' <summary>Un complemento de armadura que se está editando y todavía no se guardó.
'''
...
''' <list type="bullet">
''' <item><b>Nuevo</b>: el identificador es provisional (byte alto 0xFF) para que la armadura que lo
''' usa pueda referenciarlo antes de guardar; al guardar se le asigna el real y se reindexa.</item>
''' <item><b>Edición</b>: el identificador ES el real del record que se está sobrescribiendo.</item>
''' </list>
'''
''' <para>Los cambios de material que referencia pueden apuntar al identificador provisional de otro
''' borrador todavía sin guardar; al guardar se resuelven junto con él.</para></summary>
Public Class ArmaDraft
    ...
    Public Property Record As Canon.IArma
