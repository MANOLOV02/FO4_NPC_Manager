...
Public Class SaveEsp_Form
    ...
    ''' cuál le tocó. 0 es inequívocamente "no resuelto". Ver el comentario inline abajo, que ya lo decía
    ''' mientras este doc afirmaba lo contrario.</para></summary>
    ...
    ''' instantly. Reports progress via the optional <paramref name="progress"/> callback.
    ''' <para>Este doc estaba pegado a <c>LocalToGlobalFormID</c>, que no tiene <c>progress</c>, y esta
    ''' funcion quedaba SIN doc — con la firma ya cambiada (gano <paramref name="pluginManager"/>).</para></summary>
    Public Shared Function ScanAutoGeneratedPlugins(dataPath As String, pluginManager As PluginManager,
        ...
        For Each filePath In pluginFiles
            ...
            Try
                ...
                ' PluginManager, y el único lugar que reescribe el header a global es MergeRecords
                ' (PluginManager.vb:939). `NpcFormIDs` se compara después contra el FormID **GLOBAL** del NPC
