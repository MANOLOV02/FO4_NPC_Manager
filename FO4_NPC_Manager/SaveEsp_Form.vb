...
Public Class SaveEsp_Form
    ...
    ''' Cuando algo de eso no se puede resolver se devuelve el local sin tocar — es lo mismo que hacía antes
    ''' para TODO, así que nunca queda peor que el comportamiento previo.</para></summary>
